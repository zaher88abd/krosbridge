...
class KRosbridge {
     ...
     */
    val FIELD_CLIENT = "client"

    /**
     * The compression field for the rosbridge protocol.
     */
    val FIELD_COMPRESSION = "compression"
     ...
     */
    val FIELD_DESTINATION = "dest"

    /**
     * The end time field for the rosbridge protocol.
     */
    val FIELD_END_TIME = "end"
     ...
     */
    val FIELD_THROTTLE_RATE = "throttle_rate"
